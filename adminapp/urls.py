...
urlpatterns = [
    ...
    path('categories/update/<int:pk>/', adminapp.category_create, name='category_update'),
    path('categories/delete/<int:pk>/', adminapp.category_create, name='category_delete'),

    path('products/', adminapp.categories, name='products'),
